...
function validateInput(name,email,mobile)
{
       ...
       {
       error.innerHTML = "Name should have 20 or less characters."
       return false
       }
       else if(!name.match(alphabetLetter))
       {
       error.innerHTML = "Name should conatin only alphabets and space."
       return false
       }
       ...
       {
       error.innerHTML = "Mobile should have 10 digits."
       return false
       }
       ...
       {
       error.innerHTML = "Email should be less than 40 characters in length."
       return false
        }
       else
       {
...
addButton.addEventListener("click", function() {
   ...
   {
       error.innerHTML = "Mobile Number should have numbers only"
   }
...
nameButton.addEventListener("click",function(){
   ...
   tds[1].innerHTML = sorted_contacts[i].
